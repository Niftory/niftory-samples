...
// 
// Collection Identifier: NiftoryDapperProject
// Vault Identifier: duc
//
// Version: 0.1.1
...
transaction(storefrontAddress: Address, listingResourceID: UInt64,  expectedPrice: UFix64, commissionRecipient: Address?) {
    ...
    /// \`commissionRecipient\` - Optional recipient for transaction commission if comission exists.
    let paymentVault: @FungibleToken.Vault
    let nftCollection: &NiftoryDapperProject.Collection{NiftoryNonFungibleToken.CollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}
    let storefront: &NFTStorefrontV2.Storefront{NFTStorefrontV2.StorefrontPublic}
    let listing: &NFTStorefrontV2.Listing{NFTStorefrontV2.ListingPublic}
    ...
    prepare(dapper: AuthAccount, buyer: AuthAccount) {
        ...
        if buyer.borrow<&NiftoryDapperProject.Collection>(from: /storage/cl9j0m1e000000gmjgpwptirl_NiftoryDapperProject_nft_collection) == nil {
            let collection <- NiftoryDapperProject.createEmptyCollection() as! @NiftoryDapperProject.Collection
            buyer.save(<-collection, to: /storage/cl9j0m1e000000gmjgpwptirl_NiftoryDapperProject_nft_collection)
        }

        if (buyer.getCapability<&NiftoryDapperProject.Collection{NiftoryNonFungibleToken.CollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(/public/cl9j0m1e000000gmjgpwptirl_NiftoryDapperProject_nft_collection).borrow() == nil) {
            buyer.unlink(/public/cl9j0m1e000000gmjgpwptirl_NiftoryDapperProject_nft_collection)
            buyer.link<&NiftoryDapperProject.Collection{NiftoryNonFungibleToken.CollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(/public/cl9j0m1e000000gmjgpwptirl_NiftoryDapperProject_nft_collection, target: /storage/cl9j0m1e000000gmjgpwptirl_NiftoryDapperProject_nft_collection)
        }

        if (buyer.getCapability<&NiftoryDapperProject.Collection{NiftoryNonFungibleToken.CollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Provider,MetadataViews.ResolverCollection}>(/private/cl9j0m1e000000gmjgpwptirl_NiftoryDapperProject_nft_collection).borrow() == nil) {
            buyer.unlink(/private/cl9j0m1e000000gmjgpwptirl_NiftoryDapperProject_nft_collection)
            buyer.link<&NiftoryDapperProject.Collection{NiftoryNonFungibleToken.CollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Provider,MetadataViews.ResolverCollection}>(/private/cl9j0m1e000000gmjgpwptirl_NiftoryDapperProject_nft_collection, target: /storage/cl9j0m1e000000gmjgpwptirl_NiftoryDapperProject_nft_collection)
        }
        ...
        self.nftCollection = buyer.borrow<&NiftoryDapperProject.Collection{NiftoryNonFungibleToken.CollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(
            from: /storage/cl9j0m1e000000gmjgpwptirl_NiftoryDapperProject_nft_collection
        ) ?? panic("Cannot borrow NFT collection receiver from account")
