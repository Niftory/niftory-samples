...
export type AdminUser = Identifiable &
  UserData & {
...
export type AppUser = Identifiable &
  UserData & {
    __typename?: "AppUser";
...
export type Listing = Identifiable &
  Resource & {
    __typename?: "Listing";
    /** A unique identifier for this object in the Niftory API. */
    id: Scalars["ID"];
...
export type Nft = BlockchainEntity &
  Identifiable & {
    __typename?: "NFT";
    /** The ID of this resource on the blockchain. */
    blockchainId?: Maybe<Scalars["String"]>;
...
export type NftModel = BlockchainEntity &
  BlockchainResource &
  Identifiable &
  Resource & {
    __typename?: "NFTModel";
...
export type NftSet = BlockchainEntity &
  BlockchainResource &
  Identifiable &
  Resource & {
    __typename?: "NFTSet";
...
export type PackagingModel = Identifiable &
  Resource & {
...
export type ReadyWalletMutation = {
  __typename?: "Mutation";
  readyWallet?: {
    __typename?: "Wallet";
    id: string;
...
export type VerifyWalletMutation = {
  __typename?: "Mutation";
  verifyWallet?: {
    __typename?: "Wallet";
    id: string;
...
export type UserNftsByUserQuery = {
  __typename?: "Query";
  nfts?: Array<{ __typename?: "NFT"; id: string } | null> | null;
};
...
export type TransferNftToUserMutation = {
  __typename?: "Mutation";
  transfer?: { __typename?: "NFT"; id: string } | null;
};
...
export type NftQuery = {
  ...
  nft?: {
    ...
    model?: {
      ...
      title: string;
      description: string;
      rarity?: SimpleRarityLevel | null;
      quantity?: any | null;
      metadata?: any | null;
      content?: {
        __typename?: "NFTContent";
        poster?: { __typename?: "NFTFile"; url: any } | null;
        files?: Array<{
          __typename?: "NFTMedia";
          media: { __typename?: "NFTFile"; url: any; contentType: string };
          thumbnail?:
            | { __typename?: "NFTFile"; url: any; contentType: string }
            | { __typename?: "SimpleFile"; url: any; contentType: string }
            | null;
        } | null> | null;
      } | null;
    } | null;
...
export const ReactQuery_ReadyWalletDocument = `
  ...
  readyWallet(address: $address) {
    ...
    `;
export const useReadyWalletMutation = <TError = unknown, TContext = unknown>(
  client: GraphQLClient,
  ...
  >(
    ["readyWallet"],
    (variables?: ReadyWalletMutationVariables) =>
      fetcher<ReadyWalletMutation, ReadyWalletMutationVariables>(
        client,
        ReactQuery_ReadyWalletDocument,
        variables,
        headers
      )(),
    options
...
export const ReactQuery_RegisterWalletDocument = `
  ...
  registerWallet(address: $address) {
    ...
    `;
export const useRegisterWalletMutation = <TError = unknown, TContext = unknown>(
  client: GraphQLClient,
  options?: UseMutationOptions<
  ...
  >(
    ["registerWallet"],
    (variables?: RegisterWalletMutationVariables) =>
      fetcher<RegisterWalletMutation, RegisterWalletMutationVariables>(
        client,
        ReactQuery_RegisterWalletDocument,
        variables,
        headers
      )(),
    options
...
export const ReactQuery_VerifyWalletDocument = `
  ...
  verifyWallet(address: $address, signedVerificationCode: $signedVerificationCode) {
    ...
    `;
export const useVerifyWalletMutation = <TError = unknown, TContext = unknown>(
  client: GraphQLClient,
  options?: UseMutationOptions<
  ...
  >(
    ["verifyWallet"],
    (variables?: VerifyWalletMutationVariables) =>
      fetcher<VerifyWalletMutation, VerifyWalletMutationVariables>(
        client,
        ReactQuery_VerifyWalletDocument,
        variables,
        headers
      )(),
    options
...
export const ReactQuery_UserWalletDocument = `
  ...
  wallet {
    ...
    `;
export const useUserWalletQuery = <TData = UserWalletQuery, TError = unknown>(
  client: GraphQLClient,
  ...
  useQuery<UserWalletQuery, TError, TData>(
    ...
    fetcher<UserWalletQuery, UserWalletQueryVariables>(
      client,
      ReactQuery_UserWalletDocument,
      variables,
      headers
    ),
    options
...
export const ReactQuery_ContractDocument = `
  ...
  contract {
    ...
    `;
export const useContractQuery = <TData = ContractQuery, TError = unknown>(
  client: GraphQLClient,
  ...
  useQuery<ContractQuery, TError, TData>(
    ...
    fetcher<ContractQuery, ContractQueryVariables>(
      client,
      ReactQuery_ContractDocument,
      variables,
      headers
    ),
    options
...
>(
  ...
  useQuery<UserNftsByUserQuery, TError, TData>(
    ...
    fetcher<UserNftsByUserQuery, UserNftsByUserQueryVariables>(
      client,
      ReactQuery_UserNftsByUserDocument,
      variables,
      headers
    ),
    options
...
>(
  client: GraphQLClient,
  options?: UseMutationOptions<
    TransferNftToUserMutation,
    TError,
    TransferNftToUserMutationVariables,
    TContext
  >,
  headers?: RequestInit["headers"]
) =>
  ...
  >(
    ["transferNFTToUser"],
    (variables?: TransferNftToUserMutationVariables) =>
      fetcher<TransferNftToUserMutation, TransferNftToUserMutationVariables>(
        client,
        ReactQuery_TransferNftToUserDocument,
        variables,
        headers
      )(),
    options
...
export const ReactQuery_NftDocument = `
  ...
  nft(id: $id) {
    ...
    `;
export const useNftQuery = <TData = NftQuery, TError = unknown>(
  client: GraphQLClient,
  ...
  useQuery<NftQuery, TError, TData>(
    ["nft", variables],
    fetcher<NftQuery, NftQueryVariables>(
      client,
      ReactQuery_NftDocument,
      variables,
      headers
    ),
    options
...
export const ReactQuery_UserNftsDocument = `
  ...
  nfts {
    ...
    `;
export const useUserNftsQuery = <TData = UserNftsQuery, TError = unknown>(
  client: GraphQLClient,
  ...
  useQuery<UserNftsQuery, TError, TData>(
    ...
    fetcher<UserNftsQuery, UserNftsQueryVariables>(
      client,
      ReactQuery_UserNftsDocument,
      variables,
      headers
    ),
    options
...
export const ReactQuery_NftModelDocument = `
  ...
  nftModel(id: $id) {
    ...
    `;
export const useNftModelQuery = <TData = NftModelQuery, TError = unknown>(
  client: GraphQLClient,
  ...
  useQuery<NftModelQuery, TError, TData>(
    ["nftModel", variables],
    fetcher<NftModelQuery, NftModelQueryVariables>(
      client,
      ReactQuery_NftModelDocument,
      variables,
      headers
    ),
    options
...
export const ReactQuery_NftModelsDocument = `
  ...
  nftModels {
    ...
    `;
export const useNftModelsQuery = <TData = NftModelsQuery, TError = unknown>(
  client: GraphQLClient,
  ...
  useQuery<NftModelsQuery, TError, TData>(
    ...
    fetcher<NftModelsQuery, NftModelsQueryVariables>(
      client,
      ReactQuery_NftModelsDocument,
      variables,
      headers
    ),
    options
...
export function getSdk(
  ...
  return {
    ...
    ): Promise<ReadyWalletMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ReadyWalletMutation>(ReadyWalletDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "readyWallet",
    ...
    registerWallet(
      variables: RegisterWalletMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<RegisterWalletMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<RegisterWalletMutation>(
    ...
    verifyWallet(
      variables: VerifyWalletMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<VerifyWalletMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<VerifyWalletMutation>(
    ...
    userWallet(
      variables?: UserWalletQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<UserWalletQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UserWalletQuery>(UserWalletDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "userWallet",
    ...
    userNftsByUser(
      variables: UserNftsByUserQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<UserNftsByUserQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UserNftsByUserQuery>(
            UserNftsByUserDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "userNftsByUser",
    ...
    transferNFTToUser(
      variables: TransferNftToUserMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<TransferNftToUserMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<TransferNftToUserMutation>(
            TransferNftToUserDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "transferNFTToUser",
    ...
    nft(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<NftQuery>(NftDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "nft",
    ...
    userNfts(
      variables?: UserNftsQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<UserNftsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UserNftsQuery>(UserNftsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "userNfts",
    ...
    nftModel(
      variables: NftModelQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<NftModelQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<NftModelQuery>(NftModelDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "nftModel",
    ...
    nftModels(
      variables?: NftModelsQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<NftModelsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<NftModelsQuery>(NftModelsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "nftModels",
